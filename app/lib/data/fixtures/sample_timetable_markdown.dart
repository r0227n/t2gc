/// Bundled sample timetable used by the first-launch UI.
///
/// The content mirrors `docs/SAMPLE_TIMETABLE.md` so the app can ship the
/// reference timetable without relying on file system access at runtime.
const sampleTimetableMarkdown = '''
